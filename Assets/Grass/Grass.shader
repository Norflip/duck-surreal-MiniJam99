Shader "Roystan/Grass"
{
	...
	void geo(triangle vertexOutput IN[3], inout TriangleStream<geometryOutput> triStream)
	{
		...
		triStream.Append(VertexOutput(IN[0].vertex.xyz, IN[0].normal.xyz, float2(0,0)));
		triStream.Append(VertexOutput(IN[1].vertex.xyz, IN[1].normal.xyz, float2(0,0)));
		triStream.Append(VertexOutput(IN[2].vertex.xyz, IN[2].normal.xyz, float2(0,0)));
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {			
				...
				return col;//float4(col.rgb, col.a * dst);
            }
            ENDCG
        }
